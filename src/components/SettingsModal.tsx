...
const modelModes = {
  "gx-1.5": [
    {
      value: "basic" as AIMode,
      label: "Basic Mode",
      description: "Precise and concise answers",
      icon: Zap,
      color: "text-blue-400",
    },
    {
      value: "green" as AIMode,
      label: "Green Mode",
      description: "Helpful advice and guidance",
      icon: Leaf,
  ...
  "gx-2.0": [
    ...
    {
      value: "scary" as AIMode,
      label: "Scary Mode",
      description: "Elaborate and detailed responses",
      icon: Heart,
      color: "text-red-400",
    },
    {
      value: "companion" as AIMode,
      label: "Companion Mode",
      description: "Emotional and intimate conversations",
      icon: Heart,
      color: "text-pink-400",
    },
    {
      value: "law" as AIMode,
      label: "LAW Mode",
      description: "Legal advice and explanations",
      icon: Scale,
      color: "text-amber-400",
    },
    {
      value: "humanize" as AIMode,
      label: "Humanize AI Mode",
      description: "Humanize AI-generated text",
      icon: Wand2,
      color: "text-purple-400",
    },
    {
      value: "service" as AIMode,
      label: "SERVICE Mode",
  ...
  "gx-3.0": [
    ...
    {
      value: "gptzero" as AIMode,
      label: "GPTzero Mode",
      description: "Detect AI vs human-written text",
      icon: Search,
    ...
    {
      value: "utility" as AIMode,
      label: "Utility Mode",
      description: "Emails, messages, responses",
      icon: Briefcase,
      color: "text-indigo-400",
    },
    {
      value: "translator" as AIMode,
...
const modelLabels: Record<string, string> = {
  "gx-1.5": "GX-1.5 (Basic & Green modes)",
  "gx-2.0": "GX-2.0 (6 modes available)",
  "gx-3.0": "GX-3.0 (10 modes available)",
};
  ...
  React.useEffect(() => {
    if (isOpen) {
      ...
      if (!allowedModels.includes(settings.currentModel)) {
        ...
        const availableModes = modelModes[highest];
        const newMode =
          availableModes.length > 0 ? availableModes[0].value : "basic";
        onSettingsChange({
          ...settings,
          currentModel: highest,
          currentMode: newMode,
        });
      }
    }
  }, [allowedModels, isOpen, onSettingsChange, settings]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-6">
      ...
      >
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div>
            <h4
              className={`${darkMode ? "text-white" : "text-gray-900"} font-medium mb-3 text-sm sm:text-base`}
            >
              AI Model Selection
            </h4>
            <select
            ...
            <p
              className={`text-xs sm:text-sm ${darkMode ? "text-gray-400" : "text-gray-600"} mt-2`}
            >
          ...
          <div>
            ...
            >
              <span
                className={`font-medium ${darkMode ? "text-white" : "text-gray-900"} text-sm sm:text-base`}
              >
              ...
              <div className="mt-3 space-y-3">
                {modelModes[settings.currentModel].map((option) => {
                  ...
                  return (
                    ...
                    >
                      <Icon
                        className={`w-5 h-5 sm:w-6 sm:h-6 ${option.color} mr-3`}
                      />
                      <div className="text-left flex-1">
                        <div
                          className={`${darkMode ? "text-white" : "text-gray-900"} font-medium text-sm sm:text-base`}
                        >
                          {option.label}
                        </div>
                        <div
                          className={`${darkMode ? "text-gray-400" : "text-gray-600"} text-xs sm:text-sm`}
                        >
                          {option.description}
                        </div>
                      </div>
          ...
          {modelModes[settings.currentModel].some(
            (mode) => mode.value === "companion",
          ) && (
            <div
              className={`pt-4 ${darkMode ? "border-t border-gray-700" : "border-t border-gray-200"}`}
            >
          ...
          >
            <h4
              className={`${darkMode ? "text-white" : "text-gray-900"} font-medium mb-3 flex items-center`}
            >
            ...
            <div className="space-y-3">
              <div>
                <label
                  className={`block text-sm ${darkMode ? "text-gray-300" : "text-gray-700"} mb-1`}
                >
                  Your Name
                </label>
                <input
                  ...
                  onChange={(e) =>
                    handleUserProfileChange("name", e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleUserProfileChange("hobby", e.target.value)
                  }
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleUserProfileChange("personalInfo", e.target.value)
                  }
              ...
              <div className="grid grid-cols-2 gap-3">
                <input
                  ...
                  onChange={(e) =>
                    handleUserProfileChange("age", e.target.value)
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleUserProfileChange("occupation", e.target.value)
                  }
            ...
            <p
              className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-600"} mt-2`}
            >
              This information helps GREEN AI provide more personalized
              responses
            </p>
          </div>
          ...
          >
            <h4
              className={`${darkMode ? "text-white" : "text-gray-900"} font-medium mb-3`}
            >
              Language Selection
            </h4>
            <select
          ...
          >
            ...
            >
              <h4
                className={`${darkMode ? "text-white" : "text-gray-900"} font-medium mb-2`}
              >
                Enhanced Memory System Status
              </h4>
              <div
                className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"} space-y-1`}
              >
                ...
                {memoryStats.newestDate && (
                  <p>
                    Most recent: {memoryStats.newestDate.toLocaleDateString()}
                  </p>
                )}
                {memoryStats.topTopics.length > 0 && (
                  <p>
                    Top topics: {memoryStats.topTopics.slice(0, 3).join(", ")}
                  </p>
                )}
              </div>
              <div
              ...
              >
                <p
                  className={`${darkMode ? "text-green-300" : "text-green-700"} font-medium`}
                >
                ...
                >
                  AI remembers everything you say and can recall any
                  conversation detail
                </p>
              </div>
            </div>
            ...
            <button
              onClick={() => {
                if (
                  confirm(
                    "Are you sure you want to clear ALL conversation memory and chat history? This will permanently delete everything the AI remembers about you and your conversations. This action cannot be undone.",
                  )
                ) {
                  onClearMemory();
                }
            ...
            <p
              className={`${darkMode ? "text-gray-400" : "text-gray-600"} text-xs mt-2 text-center`}
            >
              This will permanently delete ALL conversation history, memory, and
              personal information
            </p>
          </div>
        </div>
        ...
        >
          <div
            className={`text-center ${darkMode ? "text-gray-400" : "text-gray-600"} text-sm`}
          >
